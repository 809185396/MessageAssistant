...
namespace MessageAssistant.Util
{
    ...
    public class ByteBuffer : ICloneable
    {
        ...
        private byte[] Flip(byte[] bytes, bool isLittleEndian)
        {
        ...
        public void WriteFloat(float value, bool isLittleEndian)
        {
            WriteBytes(Flip(BitConverter.GetBytes(value), isLittleEndian));
        }
        ...
        public void WriteDouble(double value, bool isLittleEndian)
        {
            WriteBytes(Flip(BitConverter.GetBytes(value), isLittleEndian));
        }
        ...
        public void WriteChar(char value, bool isLittleEndian)
        {
            WriteBytes(Flip(BitConverter.GetBytes(value), isLittleEndian));
        }
        ...
        /// </summary>
        /// <param name="value"></param>
        public void WriteBoolean(bool value, bool isLittleEndian)
        {
            WriteBytes(Flip(BitConverter.GetBytes(value), isLittleEndian));
        }
        ...
        public ushort ReadUshort(bool isLittleEndian)
        {

            return BitConverter.ToUInt16(Flip(Read(2),isLittleEndian), 0);
        }
        ...
        public short ReadShort(bool isLittleEndian)
        {
            return BitConverter.ToInt16(Flip(Read(2), isLittleEndian), 0);
        }
        ...
        public uint ReadUint(bool isLittleEndian)
        {
            return BitConverter.ToUInt32(Flip(Read(4), isLittleEndian), 0);
        }
        ...
        {
            return BitConverter.ToInt32(Flip(Read(4), isLittleEndian), 0);
        }
        ...
        public ulong ReadUlong(bool isLittleEndian)
        {
            return BitConverter.ToUInt64(Flip(Read(8), isLittleEndian), 0);
        }
        ...
        public long ReadLong(bool isLittleEndian)
        {
            return BitConverter.ToInt64(Flip(Read(8), isLittleEndian), 0);
        }
        ...
        public float ReadFloat(bool isLittleEndian)
        {
            return BitConverter.ToSingle(Flip(Read(4), isLittleEndian), 0);
        }
        ...
        {
            return BitConverter.ToDouble(Flip(Read(8), isLittleEndian), 0);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public char ReadChar(bool isLittleEndian)
        {
            return BitConverter.ToChar(Flip(Read(2), isLittleEndian), 0);
        }
        ...
        /// <returns></returns>
        public double GetDouble(int index, bool isLittleEndian)
        {
            return BitConverter.ToDouble(Flip(Get(index, 8), isLittleEndian), 0);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public double GetDouble(bool isLittleEndian)
        {
            return GetDouble(readIndex, isLittleEndian);
        }
        ...
        /// <param name="index">字节索引</param>
        /// <returns></returns>
        public float GetFloat(int index, bool isLittleEndian)
        {
            return BitConverter.ToSingle(Flip(Get(index, 4), isLittleEndian), 0);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public float GetFloat(bool isLittleEndian)
        {
            return GetFloat(readIndex, isLittleEndian);
        }
        ...
        /// <param name="index">字节索引</param>
        /// <returns></returns>
        public long GetLong(int index, bool isLittleEndian)
        {
            return BitConverter.ToInt64(Flip(Get(index, 8), isLittleEndian), 0);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public long GetLong(bool isLittleEndian)
        {
            return GetLong(readIndex, isLittleEndian);
        }
        ...
        /// <param name="index">字节索引</param>
        /// <returns></returns>
        public ulong GetUlong(int index, bool isLittleEndian)
        {
            return BitConverter.ToUInt64(Flip(Get(index, 8), isLittleEndian), 0);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public ulong GetUlong(bool isLittleEndian)
        {
            return GetUlong(readIndex, isLittleEndian);
        }
        ...
        /// <param name="index">字节索引</param>
        /// <returns></returns>
        public int GetInt(int index, bool isLittleEndian)
        {
            return BitConverter.ToInt32(Flip(Get(index, 4), isLittleEndian), 0);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public int GetInt(bool isLittleEndian)
        {
            return GetInt(readIndex, isLittleEndian);
        }
        ...
        /// <param name="index">字节索引</param>
        /// <returns></returns>
        public uint GetUint(int index, bool isLittleEndian)
        {
            return BitConverter.ToUInt32(Flip(Get(index, 4), isLittleEndian), 0);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public uint GetUint(bool isLittleEndian)
        {
            return GetUint(readIndex, isLittleEndian);
        }
        ...
        /// <param name="index">字节索引</param>
        /// <returns></returns>
        public int GetShort(int index, bool isLittleEndian)
        {
            return BitConverter.ToInt16(Flip(Get(index, 2), isLittleEndian), 0);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public int GetShort(bool isLittleEndian)
        {
            return GetShort(readIndex, isLittleEndian);
        }
        ...
        /// <param name="index">字节索引</param>
        /// <returns></returns>
        public int GetUshort(int index, bool isLittleEndian)
        {
            return BitConverter.ToUInt16(Flip(Get(index, 2), isLittleEndian), 0);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public int GetUshort(bool isLittleEndian)
        {
            return GetUshort(readIndex, isLittleEndian);
        }
        ...
        /// <param name="index">字节索引</param>
        /// <returns></returns>
        public char GetChar(int index, bool isLittleEndian)
        {
            return BitConverter.ToChar(Flip(Get(index, 2), isLittleEndian), 0);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public char GetChar(bool isLittleEndian)
        {
            return GetChar(readIndex, isLittleEndian);
        }
